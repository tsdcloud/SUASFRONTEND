  ...
  return (
    <div className='p-2 flex bg-gray-100 rounded-lg space-x-2 items-center shadow-md'>
        ...
        <div className='w-[50px] max-w-[50px] h-[50px] max-h-[50px]'>
            <img src={avatar || avatarIcon} alt="" className='flex justify-center items-center rounded-full'/>
        </div>
        ...
        <div className='flex flex-grow flex-col space-y-2'>
            ...
            <div className='flex space-x-2'>
                ...
                {/* <button className='bg-gray-700 p-2 rounded-full flex items-center justify-center'>
                    <SpeakerWaveIcon className='h-4 text-gray-100'/>
                </button> */}
